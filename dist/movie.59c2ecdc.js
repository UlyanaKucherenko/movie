          ...
          case 0:
            ...
            return fetch(_http.urls.posts, {
              ...
              if (response.ok) {
                ...
                throw new Error("Error code ".concat(response.status));
              }
            });
...
var renderList = function renderList(data) {
  data.map(function (_ref2) {
    ...
    listItem.innerHTML = "<h2>".concat(title, "</h2><span>").concat(text, "</span>");
    listItem.innerHTML += "<span> - ".concat(id, "</span>");
...
document.addEventListener("DOMContentLoaded", /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3() {
  var DATA;
